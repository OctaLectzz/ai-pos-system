...
function FieldLabel({ className, children, required = false, ...props }: React.ComponentProps<typeof Label> & { required?: boolean }) {
  ...
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label has-data-checked:border-primary/30 has-data-checked:bg-primary/5 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 flex w-fit items-center gap-1.5 leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5',
